...
- [x] **Step 2: 写入 SQLite PRAGMA 失败测试**
...
- [x] **Step 5: 为 SQLite 连接设置 WAL/NORMAL**
...
- [x] **Step 6: 将 `RetrievalService.fulltext_search()` 委托给 `LexicalRetriever`**
...
- [x] **Step 3: 扩展 `VectorStore` 构造参数与 metadata**
...
- [x] **Step 4: 实现 Markdown 标题栈和稳定节点 ID**
...
- [x] **Step 5: 让 `next_search_focus` 驱动下一轮**
...
- [x] **Step 1: 写入临时 workspace 与失败保持测试**
...
- [x] **Step 1: 在 `pyproject.toml` 声明开发检查工具**
