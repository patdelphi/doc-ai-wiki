...
| 正式质量指标 | 部分通过 | 已新增 50 条检索样例、50 条 Claim 样例、50 条 PageIndex 问题、规则样例和固定指标计算；真实评测结果仍待补 |
...
- `python -m pytest tests/unit/test_retrieval_evaluation.py tests/unit/test_evaluation_fixtures.py -q`：7 passed
