...
def build_markdown_preview_html(*, title: str, markdown_text: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "    .content { padding: 24px; line-height: 1.75; font-size: 15px; }",
            ...
            "    table { width: 100%; border-collapse: collapse; margin: 0 0 1em; font-size: 14px; }",
            "    th, td { padding: 10px 12px; border: 1px solid #d9e1ec; text-align: left; vertical-align: top; }",
